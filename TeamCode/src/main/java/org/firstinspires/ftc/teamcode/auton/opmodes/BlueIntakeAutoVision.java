...
@Autonomous(name = "BlueIntakeAutoVision")
public class BlueIntakeAutoVision extends CommandOpMode {
        ...
        schedule(new WaitUntilCommand(this::isStarted).andThen(new WaitCommand(500))
                ...
                .andThen(new SelectCommand(new HashMap<Object, Command>(){{
                    put(FFCapstoneDetector.Placement.LEFT,
                            new BlueIntakePath(drive, dropSubsystem, mIntake, liftSubsystem, 2));
                    put(FFCapstoneDetector.Placement.CENTER,
                            new BlueIntakePath(drive, dropSubsystem, mIntake, liftSubsystem, 1));
                    put(FFCapstoneDetector.Placement.RIGHT,
                            new BlueIntakePath(drive, dropSubsystem, mIntake, liftSubsystem, 0));
