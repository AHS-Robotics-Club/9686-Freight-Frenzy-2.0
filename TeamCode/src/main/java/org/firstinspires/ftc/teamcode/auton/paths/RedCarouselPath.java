...
public class RedCarouselPath extends SequentialCommandGroup {
    ...
    private Pose2d startPose = new Pose2d(-28.0, -62.0, 90.0);

    public RedCarouselPath(MecanumDriveSubsystem drive, DropSubsystem drop, Motor intake, DuckySpinnerSubsystem duckySpinner) {
...
//                .lineToLinearHeading(new Pose2d(6.0, 30.0, Math.toRadians(60.0)))
        ...
        addCommands(
                ...
                new TurnCommand(drive, Math.toRadians(230.0))                 // Turn back to shared hub
