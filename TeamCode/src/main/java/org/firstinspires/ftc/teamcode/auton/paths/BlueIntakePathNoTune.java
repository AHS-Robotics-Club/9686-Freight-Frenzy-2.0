...
public class BlueIntakePathNoTune extends SequentialCommandGroup {
    private Pose2d startPose = new Pose2d(9.0, 62.0, 0.0);

    public BlueIntakePathNoTune(MecanumDriveSubsystem drive, DropSubsystem drop, Motor intake) {
...
//                .back(12.0)
        ...
        addCommands(
                ...
                new RunCommand(drop::dropThree).raceWith(new WaitCommand(1000)),
                // First cycle
                new ParallelCommandGroup(
                        new SequentialCommandGroup(
                                new RunCommand(drop::dropFour).raceWith(new WaitCommand(1000)),
                                new RunCommand(drop::dropOne).raceWith(new WaitCommand(1000))
                        ),
                        new SequentialCommandGroup(
