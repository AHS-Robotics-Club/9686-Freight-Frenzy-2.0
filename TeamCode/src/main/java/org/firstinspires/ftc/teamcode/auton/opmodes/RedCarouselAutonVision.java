...
@Autonomous(name="RedCarouselAuton")
public class RedCarouselAutonVision extends CommandOpMode{
...
//                }))
                .andThen(new SelectCommand(new HashMap<Object, Command>(){{
                    put(FFCapstoneDetector.Placement.LEFT,
                        new RedCarouselPath(drive, dropSubsystem, mIntake, mDuckySpinner, liftSubsystem, 0));
                    put(FFCapstoneDetector.Placement.CENTER,
                        new RedCarouselPath(drive, dropSubsystem, mIntake, mDuckySpinner, liftSubsystem, 1));
                    put(FFCapstoneDetector.Placement.RIGHT,
                        new RedCarouselPath(drive, dropSubsystem, mIntake, mDuckySpinner, liftSubsystem, 2));
                    put(null,
                        new RedCarouselPath(drive, dropSubsystem, mIntake, mDuckySpinner, liftSubsystem, 0));
